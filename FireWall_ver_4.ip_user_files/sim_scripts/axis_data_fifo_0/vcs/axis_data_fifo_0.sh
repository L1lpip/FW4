...
design_libs=(xilinx_vip axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_11 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_11 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
