...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_15 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_11 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_0 xil_defaultlib.axis_data_fifo_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_data_fifo_0 -key {Behavioral:sim_1:Functional:axis_data_fifo_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
