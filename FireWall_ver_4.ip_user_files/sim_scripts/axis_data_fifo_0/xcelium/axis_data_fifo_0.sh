...
#
# Script generated by Vivado on Sun May 10 21:50:35 +07 2026
...
design_libs_elab="-libname xilinx_vip -libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_11 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_11 xil_defaultlib)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_11 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
