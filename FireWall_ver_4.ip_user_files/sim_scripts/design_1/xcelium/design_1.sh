...
#
# Script generated by Vivado on Mon May 04 23:39:53 +07 2026
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_1/ip/design_1_axi_vip_0_0/sim/design_1_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../FireWall_ver_4.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ducthanh/thanhntd/FireWall_ver_4/FireWall_ver_4.cache/compile_simlib/xcelium"
  fi
