...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L lib_pkg_v1_0_3 -L axi_apb_bridge_v3_0_19 -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
